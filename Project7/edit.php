<html>
 ...
 <?php
  ...
  $query = "update itdepends_schema.student set email_id='".$email_id."', name='".$name."', undergrad_gpa=".$undergrad_gpa.", toefl_score=".$toefl_score.", gre_score=".$gre_score.", work_experience=".$work_exp.", application_term='".$app_term."' where username='".$username."'";
  ...
  echo "Successfully updated entry for user: ".$username."<br><br>";
